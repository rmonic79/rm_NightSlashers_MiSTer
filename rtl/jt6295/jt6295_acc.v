...
generate
    if( INTERPOL) begin
        ...
        assign sample    = cen4;
        // SATURA invece di troncare: il FIR sfora i 14 bit (misurato: 8210 su
        // ingresso a fondo scala, 10727 su fronte ripido), e con il troncamento
        // il picco si RIBALTA a fondo scala opposto -> scatto violentissimo a
        // ogni colpo forte. Costo: due comparatori.
